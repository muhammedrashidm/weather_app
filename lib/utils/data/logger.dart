...
class LoggerInterceptor extends Interceptor {
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) {
    ...
    if (options.data.runtimeType == FormData) {
      final FormData op = options.data as FormData;
      logDebug(
          'onRequest: Request Data => ${_prettyJsonEncode(op.files.map((e) => e.value.length))}',
          level: Level.info);
    }
  ...
  void onResponse(Response response, ResponseInterceptorHandler handler) {
    ...
    logDebug(
        '.........................................................................\n\n\n\n');
    logDebug(
        'onResponse: StatusCode: ${response.statusCode}, Path: ${response.realUri}, Data: ${_prettyJsonEncode(response.data)}',
